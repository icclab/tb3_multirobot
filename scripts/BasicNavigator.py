...
class BasicNavigator(Node):
    def __init__(self,namespace_robot):
        super().__init__(node_name='basicnavigator',namespace=namespace_robot)
    ...
    def waitUntilNav2Active(self):
        ...
        self.info('robot_1 Nav2 is ready for use!')
        return
...
if __name__ == "__main__":
  #  def main(argv=sys.argv[1:]):
    namespace='robot_1'
    rclpy.init()
    navigator = BasicNavigator(namespace)


    # Set our demo's initial pose
    initial_pose = Pose()
    initial_pose.position.x = -2.00
    ...
    goal_pose.pose.position.x = 1.80
